...
from metadatastore.utils.testing import (dbtest_setup, dbtest_teardown, test_db_params)
...
def teardown():
    dbtest_teardown(collections, test_db_params)  # can pass drop_db=False to keep db for debugging
